...
class RedisBackend(DbBackendAbc):
    """
    A class providing an implementation of database backend of shareddatalayer, when backend
    database solution is Redis.
...
class RedisBackendLock(DbBackendLockAbc):
    """
    A class providing an implementation of database backend lock of shareddatalayer, when backend
    database solution is Redis.
