...
"""The module provides implementation of the syncronous shareddatalayer interface."""
import builtins
from typing import (Dict, Set, List, Union)
from sdl.configuration import _Configuration
from sdl.syncstorage_abc import (SyncStorageAbc, SyncLockAbc)
import sdl.backend
from sdl.backend.dbbackend_abc import DbBackendAbc
...
class SyncLock(SyncLockAbc):
    """
    This class implements abstract 'SyncLockAbc' class.
    ...
    def __init__(self, ns: str, name: str, expiration: Union[int, float],
        ...
        self.__dbbackendlock = sdl.backend.get_backend_lock_instance(ns, name, expiration,
                                                                     storage.get_backend())
...
class SyncStorage(SyncStorageAbc):
    """
    This class implements abstract 'SyncStorageAbc' class.
    ...
    def __init__(self) -> None:
        ...
        self.__dbbackend = sdl.backend.get_backend_instance(self.__configuration)
